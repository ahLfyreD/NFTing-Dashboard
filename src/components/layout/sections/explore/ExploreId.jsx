...
const ExploreId = () => {
    ...
    const { name, icon_url } = categories
    const dispatch = useDispatch();
    const { categoryId } = useParams();

    const fetchCategoryDetail = async () => {
        const response = await axios
            .get(`https://api-dev.nfting.store/api/nft-categories/${categoryId}`)
            .catch((err) => {
                console.log("Err ", err);
            });
    ...
    /* eslint-disable */
    useEffect(() => {
        if (categoryId && categoryId !== "") fetchCategoryDetail();
    }, [categoryId]);
    /* eslint-enable */
    /* eslint-disable */
    useEffect(() => {
                ...
                <div className="home">
                    <div className="section">
                        <div className="d-flex aling-items-baseline">
                            <img className="category-icon" src={icon_url} alt="" />
